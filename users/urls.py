...
urlpatterns=[
    ...
    path('change_user_password/<int:user_id>/', views.changeUserPassword, name='change_user_password'),
    path('update_user/<int:user_id>/', views.updateUserView, name='update_user')
]